...
const Hero = () => {
  ...
  return (
    ...
    >
      <motion.h1 variants={textVariant(0)} className="text-[12rem] font-semibold absolute right-[5vw] top-[8vh] background z-10">
        BOUKEN
      </motion.h1>
      <motion.h1 variants={textVariant(0)} className='text-[10rem] font-bold absolute right-[5vw] top-[33vh] z-10'>冒険</motion.h1>
      <motion.h1 variants={textVariant(0)} className='text-2xl font-semibold absolute right-[5vw] top-[62vh] text-red'>By Finn Moffett</motion.h1>
      <motion.div variants={slideIn('left', 'tween', 0, 1.5)} className='absolute left-[2vw] bottom-[5vh] flex flex-col w-[35vw] text-4xl font-semibold'>
