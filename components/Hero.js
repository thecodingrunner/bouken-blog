...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-[5rem] font-semibold sm:text-[8rem] lg:text-[10rem] absolute bottom-1/2 translate-y-14 left-1/2 -translate-x-1/2 lg:left-0 lg:-translate-x-[220px]">
