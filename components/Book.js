  ...
  return (
    <section className="flex flex-col gap-8 relative h-screen w-screen dark:text-dark-text text-light-text px-20 justify-center">
        ...
        <div className='flex gap-10 justify-center items-center'>
            ...
            {info && (
                <div className={`flex flex-col gap-6 flex-1 justify-between items-start min-w-[400px] shrink-0 dark:bg-dark-background`}>
                    ...
                    <div className='flex justify-between items-center w-full'>
                        ...
                        {info == true && (
                            <button 
                                className='w-8 h-8 rounded-full dark:bg-dark-highlight text-dark-text bg-light-highlight text-lg mr-1' 
            ...
            {info != true && (
                <button 
                    className='w-8 h-8 rounded-full dark:bg-dark-highlight text-dark-text bg-light-highlight text-lg' 
                    onClick={() => setInfo(prev => !prev)}
                >
                    i
                </button>
        ...
        <button 
            className='rounded-full dark:bg-dark-highlight text-dark-text bg-light-highlight text-lg absolute bottom-6 right-6 p-2' 
