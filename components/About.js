...
const About = () => {
  ...
  return (
    <section className="h-screen flex justify-center items-center relative">
      ...
      >
        <TypingText title="About BOUKEN 冒険" textStyles="text-center text-xl sm:text-4xl lg:text-4xl dark:text-dark-highlight text-light-highlight" />

        <motion.p variants={fadeIn("up", "tween", 0.1, 1)} className='mt-3 z-10 text-[20px] sm:text-[32px] lg:text-[34px] text-center dark:text-dark-text text-light-text italic'>
